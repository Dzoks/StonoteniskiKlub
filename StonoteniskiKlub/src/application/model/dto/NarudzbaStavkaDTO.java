...
public class NarudzbaStavkaDTO {
	...
	public NarudzbaStavkaDTO() {
		super();
	}

	public NarudzbaStavkaDTO(Integer idNarudzbe, Integer idTipaOpreme, String velicina, Integer kolicina, Double cijena, Boolean obradjeno) {
		super();
