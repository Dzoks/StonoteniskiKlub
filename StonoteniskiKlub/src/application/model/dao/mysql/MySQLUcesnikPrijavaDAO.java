...
public class MySQLUcesnikPrijavaDAO implements UcesnikPrijavaDAO {
	...
	// private final static String SQL_GET_BY_ID = "select * from
	// UCESNIK_PRIJAVA u left join OSOBA o on u.OSOBA_Id=o.Id where u.Id=?";
	private final static String SQL_INSERT = "{call prijaviUcesnika(?,?,?,?,?,?,?,?,?)}";
	// private final static String SQL_SELECT_ALL = "select * from
	// UCESNIK_PRIJAVA u inner join OSOBA o on u.OSOBA_Id = o.Id "
	...
	//
	// public static ObservableList<UcesnikPrijavaDTO> getAll(Integer
	// idTurnira,Integer idKategorije) {
	// ObservableList<UcesnikPrijavaDTO> retVal =
	...
	// rs = ps.executeQuery();
	// while (rs.next())
	// retVal.add(new UcesnikPrijavaDTO(rs.getInt("OSOBA_Id"),
	// rs.getString("Ime"), rs.getString("Prezime"),
	// rs.getString("JMB"), rs.getString("Pol").charAt(0),
	...
	// rs=ps.executeQuery();
	// if(rs.next()){
	// retVal=new UcesnikPrijavaDTO(rs.getInt("OSOBA_Id"), rs.getString("Ime"),
	// rs.getString("Prezime"),
	// rs.getString("JMB"), rs.getString("Pol").charAt(0),
	// rs.getDate("DatumRodjenja"),
	// id, rs.getInt("TURNIR_Id"),
